...
HD_PWD='C:/Users/Anumita Samaddar/cnn_layer_accelerator/cnn_layer_accelerator.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log convolution_accelerator.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source convolution_accelerator.tcl
