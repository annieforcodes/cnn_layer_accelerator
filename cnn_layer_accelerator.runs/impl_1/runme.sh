...
HD_PWD='C:/Users/Anumita Samaddar/cnn_layer_accelerator/cnn_layer_accelerator.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log convolution_accelerator.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source convolution_accelerator.tcl -notrace
